...
export default function BecomeSponsorModal({ isOpen, onClose }: BecomeSponsorModalProps) {
        ...
        {status !== "success" ? (
          <>
            ...
            <p className="modal-subtitle">
              Request the sponsor deck or book a fit call, tell us your goals and we'll follow up
            </p>
          ...
          <div style={{ textAlign: "center", padding: "24px 0" }}>
            ...
            <p className="success-message" style={{ marginBottom: "28px" }}>
              Thank you for reaching out. We have received your inquiry about becoming a sponsor and will follow up with you shortly.
            </p>
            <button
              onClick={onClose}
